...
2. Install requirements from `requirements.txt` and `datasources/requirements-download.txt` (e.g. `pip install -r requirements.txt`).
...
### For CUB dataset
1. Run `datasources/cub_download.py`.
2. Run `datasources/cub_preprocess.py`.
