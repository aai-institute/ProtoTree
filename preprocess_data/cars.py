...
training_output = (
    path + "train/"
)  # specify target trainig image path (trainig images need to be orgnized to specific structure)
...
testing_output = (
    path + "test/"
)  # specify target testing image path (testing images need to be orgnized to specific structure)
