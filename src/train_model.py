    ...
    match model_type:
        case "prototree":
            ...
            save_tree_visualization(
                model, prototypes_info, tree_dir, class_names, global_scores=global_expl
            )
        case "protopnet":
            save_prototypes(
                proto_info=prototypes_info, img_size=img_size, global_expl=global_expl
            )
        case _:
            raise ValueError(f"Unknown model type {model_type}.")
